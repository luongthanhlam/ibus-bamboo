...
// from: https://gitlab.freedesktop.org/wayland/wayland-protocols/-/raw/d10d18f3d49374d2e3eb96d63511f32795aab5f7/stable/xdg-shell/xdg-shell.xml
// on 2021-03-10 03:11:11 +0530
...
//
func (p *Positioner) SetParentSize(parent_width, parent_height int32) error {
...
// subsurfaces.
//
func (p *Surface) SetWindowGeometry(x, y, width, height int32) error {
...
//
func (p *Toplevel) ShowWindowMenu(seat *wl.Seat, serial uint32, x, y int32) error {
...
//
func (p *Toplevel) Resize(seat *wl.Seat, serial, edges uint32) error {
...
// protocol error.
//
func (p *Toplevel) SetMaxSize(width, height int32) error {
...
// protocol error.
//
func (p *Toplevel) SetMinSize(width, height int32) error {
