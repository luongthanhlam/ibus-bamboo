...
// from: https://gitlab.freedesktop.org/wayland/wayland-protocols/-/raw/d10d18f3d49374d2e3eb96d63511f32795aab5f7/unstable/xdg-shell/xdg-shell-unstable-v6.xml
// on 2021-03-10 03:11:13 +0530
...
func (p *Shell) Dispatch(event *wl.Event) {
	switch event.Opcode {
	case 0:
		p.mu.RLock()
