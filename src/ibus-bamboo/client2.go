...
func NewZwlrForeignToplevelHandleV1(ctx *wl.Context, id wl.ProxyID) *ZwlrForeignToplevelHandleV1 {
...
//
func (p *ZwlrForeignToplevelHandleV1) SetRectangle(surface *wl.Surface, x, y, width, height int32) error {
